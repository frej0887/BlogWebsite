...
export const Dinosaur = () => {
  return (
    <MyOuter>
      ...
      <MyMaterialList materialListItems={[
        {
          ...
          link: 'https://www.imerco.dk/casa-living-vandkande-dinosaur-1-liter-plastik-groen?id=100433309',
        },
        {
          text: 'Acrylic paint',
        },
        {
          text: 'Panduro Limitless Marker',
          link: 'https://panduro.com/da-dk/products/mal-tegn/blyanter-penne-kridt/tuschpenne-markers/limitless-marker-m-white-w01-medium-spids-o25-mm-970916'
        },
        {
          text: 'Schjerning Art Acrylic Lacquer',
          link: 'https://www.tidensfarver.com'
        },
      ]}/>
      ...
      <MyHeader2>Newly learned techniques</MyHeader2>
